        ...
        <v-form class="multi-col-validation">
            <v-card-text class="pt-5">
                <v-row>
                    ...
                    <v-col cols="12" md="6">
                        <v-select v-model="optionsLocal.country" outlined dense label="Country" :items="['USA','UK','AUSTRALIA','BRAZIL']"></v-select>
                    </v-col>
                    <v-col cols="12" md="6">
                        <v-select v-model="optionsLocal.languages" outlined dense multiple chips small-chips label="Languages" :items="['English','Spanish','French','German']"></v-select>
                    </v-col>
                    <v-col cols="12" md="6">
